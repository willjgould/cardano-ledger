...
-- hardForkInitiationSpec :: BabelEraImp era => SpecWith (ImpTestState era)
-- hardForkInitiationSpec =
...
-- hardForkInitiationNoDRepsSpec :: BabelEraImp era => SpecWith (ImpTestState era)
-- hardForkInitiationNoDRepsSpec =
...
-- noConfidenceSpec :: forall era. BabelEraImp era => SpecWith (ImpTestState era)
-- noConfidenceSpec =
--   it "NoConfidence" $ do
--     modifyPParams $ \pp ->
--       pp
...
-- constitutionSpec :: BabelEraImp era => SpecWith (ImpTestState era)
-- constitutionSpec =
--   it "Constitution" $ do
--     (committeeMember :| _) <- registerInitialCommittee
--     (dRep, _, _) <- setupSingleDRep 1_000_000
